...
export class UpdateUser extends React.Component<UpdateUserProps, UpdateUserState>{
    ...
    handleSubmit(event: any) {
        UserService.updateUser(this.state).then(res => console.log(res));
            ...
            <form onSubmit={this.handleSubmit}>
                <div style={{ marginLeft: '20px' }}>
                    ...
                    <FormControl>
                        ...
                        <BootstrapInput id="demo-customized-textbox" type="text" name="password" placeholder="Password" onChange={this.handleChange} />
                    </FormControl>
                    <br />
                    <br />
